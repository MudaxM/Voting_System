...
<head>
    ...
    <style>
        ...
        .stat-icon.voters { background-color: #dbeafe; color: var(--info); }
        .stat-icon.positions { background-color: #f3e8ff; color: #8b5cf6; }
        .stat-icon.candidates { background-color: #fef3c7; color: var(--warning); }
        .stat-icon.votes { background-color: #d1fae5; color: var(--success); }
        .stat-content h3 {
            font-size: 2rem;
            margin-bottom: 5px;
            color: var(--dark);
        ...
        .activity-icon.login { background-color: #dbeafe; color: var(--info); }
        .activity-icon.vote { background-color: #d1fae5; color: var(--success); }
        .activity-icon.register { background-color: #fef3c7; color: var(--warning); }
        .activity-icon.admin { background-color: #f3e8ff; color: #8b5cf6; }
        .activity-details {
            flex-grow: 1;
        }
        .activity-user {
        ...
        .health-status.good { color: var(--success); }
...
<body>
    ...
    <nav class="admin-sidebar" id="adminSidebar">
        ...
        <ul class="admin-nav">
            ...
            <li class="admin-nav-item">
                <a href="manage_voters.php" class="admin-nav-link">
                    <i class="fas fa-users"></i>
                    Manage Voters
                </a>
            </li>
            <li class="admin-nav-item">
                <a href="manage_candidates.php" class="admin-nav-link">
                    <i class="fas fa-user-tie"></i>
                    Manage Candidates
                </a>
            </li>
            <li class="admin-nav-item">
                <a href="manage_positions.php" class="admin-nav-link">
        ...
        <div class="sidebar-footer" style="position: absolute; bottom: 20px; left: 0; right: 0; padding: 20px; border-top: 1px solid rgba(255,255,255,0.1);">
            <div style="color: #94a3b8; font-size: 0.8rem;">
                <p><i class="fas fa-server"></i> System: Online</p>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="status-badge status-active" style="margin-left: 5px;">Voted</span>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                    ...
                    <div>
                        ...
                        <div class="dashboard-card">
                            ...
                            <div style="position: relative; padding-left: 20px;">
                                <div style="position: absolute; left: 8px; top: 0; bottom: 0; width: 2px; background-color: var(--primary);"></div>
                                ...
                                <div style="position: relative; margin-bottom: 1.5rem;">
                                    <div style="position: absolute; left: -16px; top: 0; width: 10px; height: 10px; border-radius: 50%; 
